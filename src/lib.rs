...
#[derive(Debug)]
pub struct Web3MarketProcessor {
    verbose: bool,
    processed_count: usize,
}

impl Web3MarketProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting Web3Market processing");
    
    let mut processor = Web3MarketProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = Web3MarketProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = Web3MarketProcessor::new(false);
